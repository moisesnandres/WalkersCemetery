...
# Crear los sectores
Sector.create(nombre: 'Virgen de Yauca', capacidad: 100)
Sector.create(nombre: 'San Martin de Porras', capacidad: 50)
Sector.create(nombre: 'Virgen del Carmen', capacidad: 75)
Sector.create(nombre: 'San Luis Gonzaga', capacidad: 85)
Sector.create(nombre: 'Santa Rita', capacidad: 100)
Sector.create(nombre: 'Cristo Rey', capacidad: 50)
Sector.create(nombre: 'Luren I', capacidad: 75)
Sector.create(nombre: 'Luren II', capacidad: 85)
Sector.create(nombre: 'Luren III', capacidad: 100)
Sector.create(nombre: 'San Pedro', capacidad: 50)
